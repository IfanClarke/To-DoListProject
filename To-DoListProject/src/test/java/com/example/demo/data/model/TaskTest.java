...
public class TaskTest {
	...
	public void taskConstructor2() {
		this.taskTest = new Task(1, "Clean House", "Ensure every room is clean", "2021-06-19 11:10", "Very high", true,
				null);
	}
	...
	public void toStringTest() {
		...
		assertThat(taskTest).hasToString("Task [id=" + taskTest.getId() + ", task=" + taskTest.getTask()
				+ ", description=" + taskTest.getDescription() + ", deadline=" + taskTest.getDeadline() + ", priority="
				+ taskTest.getPriority() + ", done=" + taskTest.getDone() + ", subtaskLink=" + taskTest.getSubtaskLink()
				+ "]");
	}
